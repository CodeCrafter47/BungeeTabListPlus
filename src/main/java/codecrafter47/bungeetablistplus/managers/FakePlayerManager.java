...
public class FakePlayerManager {
    ...
    public static class FakePlayer implements ProxiedPlayer{
        ...
        @Override public void sendMessage(ChatMessageType chatMessageType, BaseComponent... baseComponents) {

        }

        @Override public void sendMessage(ChatMessageType chatMessageType, BaseComponent baseComponent) {
