...
public class SortingRuleAliasProcessor implements SortingRulePreprocessor {
    ...
    private static final ImmutableMap<String, RewriteData> map = ImmutableMap.<String, RewriteData>builder()
            ...
            .put("luckpermsgroupinfo", new RewriteData("luckpermsvelocity_primary_group_weight asc", true))
            .put("luckpermsgroupinforeversed", new RewriteData("luckpermsvelocity_primary_group_weight desc", true))
