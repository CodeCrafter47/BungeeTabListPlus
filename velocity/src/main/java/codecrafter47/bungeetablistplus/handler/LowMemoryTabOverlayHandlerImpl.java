...
public class LowMemoryTabOverlayHandlerImpl extends TabOverlayHandlerImpl {
    ...
    public LowMemoryTabOverlayHandlerImpl(Logger logger, Executor eventLoopExecutor, UUID viewerUuid, Player player, boolean is18, boolean has113OrLater, boolean has119OrLater, boolean has1203OrLater) {
        super(logger, eventLoopExecutor, viewerUuid, player, is18, has113OrLater, has119OrLater, has1203OrLater);
    }
