...
public class LowMemoryTabOverlayHandlerImpl extends TabOverlayHandlerImpl {
    ...
    public LowMemoryTabOverlayHandlerImpl(Logger logger, Executor eventLoopExecutor, UUID viewerUuid, Player player, boolean is18, boolean has113OrLater, boolean has119OrLater) {
