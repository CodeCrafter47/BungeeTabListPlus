...
public class UpdateChecker implements Runnable {
    ...
    public UpdateChecker(VelocityPlugin plugin) {
        this.plugin = plugin;
    }
    ...
    public void run() {
        ...
        try {
            ...
            URL url = new URL( "http://updates.codecrafter47.dyndns.eu/" + plugin.getVersion() + "/version.txt");
            ...
            // compare versions
            String runningVersion = plugin.getVersion();
